...
<body>
<c:set var="menu" value="bookmodify" />
<div class="container">
	...
	<div class="row">
		<div class="col-xs-offset-2 col-xs-8">
			<div class="panel panel-default">
				<div class="panel-heading">책 수정</div>
				<div class="panel-body">
					<form id="register-form" method="post" action="modify.do" enctype="multipart/form-data">
						...
						<div class=form-group>
							<label>포인트</label>
							<input type="number" class="form-control" name="point" value="${book.point }">
						</div>
						<div class=form-group>
							<label>표지</label>
							<input type="file" class="form-control" name="front">
							<span class="help-block"> * 현재 첨부파일 : ${not empty book.front ? book.front : '없음'  }</span>
						</div>
						<div class=form-group>
							<label>페이지 <button id="add-btn"> + </button></label>
							<input type="file" class="form-control" name="upfile">
							<c:forEach var="bookImgs" items="${bookImgs }">
							<span class="help-block"> * 현재 첨부파일 : ${not empty bookImgs.imageRoute ? bookImgs.imageRoute : '없음'  }</span>
							</c:forEach>
						</div>
						<div id="button-box" class=form-group>
							<label>마지막장</label>
							<input type="file" class="form-control" name="back">
							<span class="help-block"> * 현재 첨부파일 : ${not empty book.back ? book.back : '없음'  }</span>
						</div>
